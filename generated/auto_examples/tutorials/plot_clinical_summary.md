...
<!-- "generated/auto_examples/tutorials/plot_clinical_summary.py" -->
<!-- LINE NUMBERS ARE GIVEN BELOW. -->

<a id="sphx-glr-generated-auto-examples-tutorials-plot-clinical-summary-py"></a>
...
We use the `eegdash.EEGDash` client to fetch all available datasets.
...
<!-- GENERATED FROM PYTHON SOURCE LINES 107-168 -->
```Python
